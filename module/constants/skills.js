export const SKILLS = {
    crafting: {
        label: 'system.skills.crafting.label',
        alchemy: {
    ...
    exploration: {
        label: 'system.skills.exploration.label',
        climb: {
    ...
    interpersonal: {
        label: 'system.skills.interpersonal.label',
        brag: {
            label: 'system.skills.interpersonal.brag.label',
            use: 'system.skills.interpersonal.brag.use',
            default: 'presence',
        },
        empathize: {
            label: 'system.skills.interpersonal.empathize.label',
            use: 'system.skills.interpersonal.empathize.use',
            default: 'presence',
        },
        flirt: {
            label: 'system.skills.interpersonal.flirt.label',
            use: 'system.skills.interpersonal.flirt.use',
            default: 'presence',
        },
        gamble: {
            label: 'system.skills.interpersonal.gamble.label',
        ...
        interrogate: {
            label: 'system.skills.interpersonal.interrogate.label',
            use: 'system.skills.interpersonal.interrogate.use',
            default: 'presence',
        },
        intimidate: {
            label: 'system.skills.interpersonal.intimidate.label',
            use: 'system.skills.interpersonal.intimidate.use',
            default: 'presence',
        },
        lead: {
            label: 'system.skills.interpersonal.lead.label',
            use: 'system.skills.interpersonal.lead.use',
            default: 'presence',
        },
        lie: {
            label: 'system.skills.interpersonal.lie.label',
            use: 'system.skills.interpersonal.lie.use',
            default: 'presence',
        },
        music: {
            label: 'system.skills.interpersonal.music.label',
    ...
    intrigue: {
        label: 'system.skills.intrigue.label',
        alertness: {
        ...
        disguise: {
            ...
            use: 'system.skills.intrigue.disguise.use',
            default: 'presence',
        },
        eavesdrop: {
    ...
    lore: {
        label: 'system.skills.lore.label',
        culture: {
